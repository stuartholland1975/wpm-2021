...
import PeriodSupervisorStats from './PeriodSupervisorStatsDataGrid';
import PeriodActivityStats from './PeriodActivityStatsDataGrid';
...
query GetPeriodAnalysisData($period: Int!) {
  query {
    ...
    periodAnaysisAreaValues(condition: {periodNumber: $period}orderBy: AREA_ID_ASC) {
      nodes {
        area
        periodNumber
        valueComplete
